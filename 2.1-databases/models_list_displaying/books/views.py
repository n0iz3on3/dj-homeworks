    ...
    for page, book in enumerate(sorted_books_objects, 1):
        if pub_date == book.pub_date:
            ...
            if page.has_previous():
                prev_page_by_date = paginator.page(page.previous_page_number()).object_list[0].pub_date
                context['prev_page'] = prev_page_by_date
            if page.has_next():
                next_page_by_date = paginator.page(page.next_page_number()).object_list[0].pub_date
